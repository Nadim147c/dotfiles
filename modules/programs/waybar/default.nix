...
delib.module {
    ...
    in {
        home.activation.compileWaybarSyle = inputs.home-manager.lib.hm.dag.entryAfter ["writeBoundary"] ''
            ${pkgs.coreutils}/bin/install -Dm644 ${./style.scss} ${xdg.configHome}/waybar/style.scss
            ${pkgs.compile-scss}/bin/compile-scss ${xdg.configHome}/waybar/style.scss
        '';
        ...
        programs.waybar.settings.main = {
            ...
            "custom/notification_mode" = {
                format = "{}";
                tooltip-format = "Toggle notification mode";
                interval = 1;
