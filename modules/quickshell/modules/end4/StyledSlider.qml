...
Slider {
    ...
    property color highlightColor: Appearance.material.myPrimary
    property color trackColor: Appearance.material.myOnSecondaryContainer
    property color handleColor: Appearance.material.myPrimary
    property color dotColor: Appearance.material.myOnSecondaryContainer
    property color dotColorHighlighted: Appearance.material.myOnPrimary
    property real unsharpenRadius: Appearance.round.none
